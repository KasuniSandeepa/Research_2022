...
class InputfarmerSelectionForm extends StatefulWidget {
  ...
  const InputfarmerSelectionForm({Key? key,
  ...
  @override
  State<InputfarmerSelectionForm> createState() => _InputfarmerSelectionFormState();
}

class _InputfarmerSelectionFormState extends State<InputfarmerSelectionForm> {
  ...
  final  List<String> priceRange = ['Very High', 'High', 'Average', 'Low'];
  final  List<String> quantityRange = ['Very High', 'High', 'Average', 'Low'];
 ...
 int val = -1;
  ...
  RangeValues _currentQuantityRangeValues = const RangeValues(40, 80);
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField(
                      ...
                      items: quantityRange.map((account) {
                        return DropdownMenuItem(
                          child: Text(account),
                          value: account,
                        );
                        ...
                        child: ElevatedButton(
                          onPressed: () async {
                                ...
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (context) => FarmerOutput(rating: getRate, quantityRange: getQuantity, tasteQuality: getTasteQuality, priceRang: getPrice, lat: position.latitude.toString(), long: position.longitude.toString())
                                    ),
                                  );
