...
import '../../components/inputWholesalerSelectionForm.dart';

class InputWholesalerSelection extends StatelessWidget {
  InputWholesalerSelection({Key? key}) : super(key: key);
          ...
          title: Row(
            children: [
              Column(
                ...
                children: const [
                  Text('Select The Best Wholesaler'),
                ],
              ),
            ],
          ),
              ...
              Expanded(
                  child: Container(
                      ...
                      child: ClipRRect(
                          ...
                          child: InputWholesalerSelectionForm(
