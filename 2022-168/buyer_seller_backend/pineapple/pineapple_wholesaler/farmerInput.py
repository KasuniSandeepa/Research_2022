from pineapple.pineapple_wholesaler.intersectHighQuantity import *
from pineapple.pineapple_wholesaler.intersectLowQuantity import *
from pineapple.pineapple_wholesaler.intersectMediumQuantity import *
from pineapple.pineapple_wholesaler.intersectAvgQuantity import *
...
def farmerSelections(price, tastQuality, rate, quantity):
    if quantity == 'Vhigh':
...
# output = farmerSelections()
# finalOutput = output[['WholesellerId','TasteQuality','price','Ratings','Quantity']]
# print(finalOutput)