...
with open('pineapple/pineapple_wholesaler/clusterWholesalerTasteModel.pkl', 'rb') as file:
...
plt.xlabel('Pineappple TastQuality')
plt.ylabel('Ratings')
plt.title('Clusters of TastQuality & Ratings')
