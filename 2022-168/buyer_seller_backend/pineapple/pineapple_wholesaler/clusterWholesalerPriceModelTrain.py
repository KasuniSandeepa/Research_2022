...
plt.scatter(data['price'], data['Ratings'])
...
plt.title('k value for pineapple price')
plt.plot(k_values, wcss_error)

# train model using k=5
model = KMeans(n_clusters=4)
pred = model.fit_predict(data[['price', 'Ratings']])
...
with open('clusterWholesalerPriceModel.pkl', 'wb') as file:
